...
public interface SerieRepository extends JpaRepository<Serie,Long> {
        ...
        List<Episodio> top5Episodios(Serie serie);    List<Serie> findByTotalTemporadasLessThanEqualAndEvaluacionGreaterThanEqual(int totalTemporadas, Double evaluacion);
